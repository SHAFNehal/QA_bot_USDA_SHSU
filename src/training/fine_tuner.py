...
# Allow running this file directly: `python src/training/fine_tuner.py`
...
def train(model, tokenizer, train_dataset, eval_dataset, output_dir,
    ...
    training_args = TrainingArguments(
        ...
        save_strategy="steps",
        eval_strategy="steps",  # Changed from evaluation_strategy to eval_strategy for newer transformers versions
